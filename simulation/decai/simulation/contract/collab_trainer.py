...
class DefaultCollaborativeTrainer(CollaborativeTrainer):
    ...
    def add_data(self, msg: Msg, submitter: str, data, classification):
        # Consider making sure duplicate data isn't added until it's been claimed.

        # cost, update_model = self.im.handle_add_data(msg.sender, submitter, msg.value, data, classification)
